...
namespace render 
{
	void init() {
		...
		fonts::isis = io.Fonts->AddFontFromFileTTF(_("C:\\Windows\\Fonts\\Verdana.ttf"), 18.0f, NULL, io.Fonts->GetGlyphRangesJapanese());
		fonts::icon_font = io.Fonts->AddFontFromMemoryTTF(_((void*)Icons), sizeof(Icons), 18, &font_config, io.Fonts->GetGlyphRangesDefault());
		fonts::font = io.Fonts->AddFontFromFileTTF(_("C:\\Windows\\Fonts\\Verdana.ttf"), 16.0f, NULL, io.Fonts->GetGlyphRangesCyrillic());
		fonts::mainfont = io.Fonts->AddFontFromFileTTF(_("C:\\Windows\\Fonts\\Verdana.ttf"), 14.0f, NULL, io.Fonts->GetGlyphRangesCyrillic());
