...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            ImGui::Text("Current");
            ImGui::ColorButton("##current", color, false, ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(60,40));
            ImGui::Text("Previous");
            if (ImGui::ColorButton("##previous", backup_color, false, ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(60,40)))
                color = backup_color;
            ImGui::Separator();
            ImGui::Text("Palette");
            for (int n = 0; n < IM_ARRAYSIZE(saved_palette); n++)
            {
                ...
                if (ImGui::ColorButton("##palette", saved_palette[n], false, palette_button_flags, ImVec2(20,20)))
        ...
        ImGui::ColorButton("MyColor##3c", *(ImVec4*)&color, false, misc_flags | (no_border ? ImGuiColorEditFlags_NoBorder : 0), ImVec2(80,80));
